...
################################################################################
# Nginx Stage
FROM h3nc4/nginx-slim:latest@sha256:25f5d60d58853043b8d0e49402ea90ce4b27f166e97ac77b546ff756a0dd832f AS nginx

################################################################################
# Assemble Root Filesystem
FROM alpine:3.24@sha256:294b683cb724975bec92580e1e685676bd4b50bda910ddb8c51d4cabeaec77e6 AS rootfs-builder
ARG CGIT_VERSION
ARG CGIT_ROOT
ARG USER
ARG GROUP
