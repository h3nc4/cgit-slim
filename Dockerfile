...
################################################################################
# Nginx Stage
FROM h3nc4/nginx-slim:latest@sha256:eba9ddb6019f11fec3e18ffd6a60fae2e79004e86caed9fb10cbecef862265b2 AS nginx

################################################################################
# Assemble Root Filesystem
FROM alpine:3.24@sha256:28bd5fe8b56d1bd048e5babf5b10710ebe0bae67db86916198a6eec434943f8b AS rootfs-builder
ARG CGIT_VERSION
ARG CGIT_ROOT
ARG USER
ARG GROUP
