...
################################################################################
# Nginx Stage
FROM h3nc4/nginx-slim:latest@sha256:17f1bba6e2d1a16f273ed49931cd893e458ddf9b8b6dc7c269561fecd200a7a4 AS nginx

################################################################################
# Assemble Root Filesystem
FROM alpine:3.23@sha256:5b10f432ef3da1b8d4c7eb6c487f2f5a8f096bc91145e68878dd4a5019afde11 AS rootfs-builder
ARG CGIT_VERSION
ARG CGIT_ROOT
ARG USER
ARG GROUP
